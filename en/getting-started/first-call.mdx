...
description: "Step-by-step tutorial for making your first AI-powered call with Talqover"
---

# Make Your First Call

This tutorial will walk you through making your first AI-powered call using the Talqover API. You'll learn how to get your agent ID and make a test call.
...
1. **Log in** to your Talqover dashboard at [talqover.app](https://talqover.app)
...
- **Join our community** on [Discord](https://discord.gg/RMP4bpFrCF) for support

<Check>
  🎉 You've successfully made your first call with Talqover! Your AI voice agent is now ready to handle conversations.
</Check>
