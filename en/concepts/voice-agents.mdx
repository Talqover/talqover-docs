---
title: "Voice Agents"
description: "Learn about AI voice agents and how they handle conversations in Talqover"
---

# Voice Agents

Voice agents are the AI personalities that handle your calls in the Talqover platform. They are intelligent conversational AI systems that can engage in natural, human-like conversations over the phone.

## What are Voice Agents?

Voice agents are AI-powered conversational interfaces that can:

- **Understand natural language** - Process what callers say in real-time
- **Respond intelligently** - Provide relevant, contextual responses
- **Handle complex conversations** - Navigate multi-turn dialogues
- **Adapt to context** - Remember conversation history and adjust responses
- **Execute actions** - Perform tasks based on conversation outcomes

## How Voice Agents Work

### 1. Natural Language Processing (NLP)

Voice agents use advanced NLP to:
- **Transcribe speech** - Convert spoken words to text
- **Understand intent** - Determine what the caller wants
- **Extract entities** - Identify key information (names, dates, numbers)
- **Analyze sentiment** - Understand caller emotions and tone
...
1. **Log in to your dashboard** at [talqover.app](https://talqover.app)
