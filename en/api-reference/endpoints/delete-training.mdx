...
api: "DELETE /api/v1/agents/{agent}/trainings/{training}"
---
...
```
DELETE /api/v1/agents/{agent}/trainings/{training}
```
...
- **List Trainings**: `GET /api/v1/agents/{agent}/trainings`
- **Create/Update Training**: `POST /api/v1/agents/{agent}/trainings`
