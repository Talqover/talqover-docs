...
curl -X GET "https://talkover.app/api/v1/voice-templates?gender=female&quality_tier=pro" \
  -H "Authorization: Bearer talq_your_environment_token_here"
```

```javascript
// Request 3: Get female pro quality templates
const response = await fetch('https://talkover.app/api/v1/voice-templates?gender=female&quality_tier=pro', {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer talq_your_environment_token_here'
  }
