...
- **Update Agent Voice**: `PUT /api/v1/agents/{agent}/voice`
- **Update Agent Calling Settings**: `PUT /api/v1/agents/{agent}/calling`
- **Publish Agent**: `POST /api/v1/agents/{agent}/publish`
- **Unpublish Agent**: `POST /api/v1/agents/{agent}/unpublish`
- **Delete Agent**: `DELETE /api/v1/agents/{agent}`
