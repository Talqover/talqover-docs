...
curl -X GET "https://talqover.app/api/v1/phone-numbers" \
  -H "Authorization: Bearer talq_your_environment_token_here"
```

```javascript
// Request 1: Get all phone numbers
const response = await fetch('https://talqover.app/api/v1/phone-numbers', {
  method: 'GET',
  headers: {
...
curl -X GET "https://talqover.app/api/v1/phone-numbers?has_voice=true" \
  -H "Authorization: Bearer talq_your_environment_token_here"
```

```javascript
// Request 2: Get phone numbers with voice capability
const response = await fetch('https://talqover.app/api/v1/phone-numbers?has_voice=true', {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer talq_your_environment_token_here'
  }
...
curl -X GET "https://talqover.app/api/v1/phone-numbers?search=+1234567890" \
  -H "Authorization: Bearer talq_your_environment_token_here"
```

```javascript
// Request 3: Search for a specific phone number
const response = await fetch('https://talqover.app/api/v1/phone-numbers?search=+1234567890', {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer talq_your_environment_token_here'
  }
