...
description: "Tutorial passo a passo para fazer sua primeira chamada com IA usando o Talqover"
---

# Faça Sua Primeira Chamada

Este tutorial irá guiá-lo através da criação de sua primeira chamada com IA usando a API Talqover. Você aprenderá como obter seu ID do agente e fazer uma chamada de teste.
...
```
POST https://talqover.app/api/v1/agents/{agent_id}/call
```

#### Chamada de Campanha
```
POST https://talqover.app/api/v1/campaigns/{campaign_id}/call
```
...
- **Junte-se à nossa comunidade** no [Discord](https://discord.gg/RMP4bpFrCF) para suporte

<Check>
  🎉 Você fez sua primeira chamada com o Talqover com sucesso! Seu agente de voz com IA agora está pronto para lidar com conversas.
</Check>
