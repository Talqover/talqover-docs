...
description: "Aprenda como criar e configurar rapidamente seu agente de voz através da interface baseada em chat do Talqover"
---

# Configuração do Agente de Voz

O Talqover torna a configuração de um agente de voz incrivelmente simples através da nossa interface intuitiva baseada em chat. Em vez de lidar com configurações técnicas complexas, você pode criar um agente de voz profissional em apenas alguns minutos através de uma conversa guiada.
...
```
Talqover: "Olá! Estou aqui para ajudá-lo a criar seu agente de voz. 
Com o que você gostaria que seu agente ajudasse?"

Você: "Preciso de um agente para suporte ao cliente"

Talqover: "Ótimo! Um agente de suporte ao cliente. Qual é o nome da sua empresa 
...
```
Talqover: "Como você gostaria que seu agente soasse ao falar com os clientes?"
...
mas não muito conversador, e sempre educado."
```
...
```
Talqover: "Quais são as principais coisas sobre as quais os clientes ligam?"
...
Para saúde:
• "Agendar compromissos"
• "Verificar informações de seguro"
...
```
Talqover: "Há alguma pergunta específica que os clientes fazem 
