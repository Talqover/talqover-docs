...
curl -X GET "https://talkover.app/api/v1/voice-templates" \
  -H "Authorization: Bearer talq_your_environment_token_here"
```

```javascript
// Requisição 1: Obter todos os modelos de voz
const response = await fetch('https://talkover.app/api/v1/voice-templates', {
  method: 'GET',
  headers: {
...
curl -X GET "https://talkover.app/api/v1/voice-templates?language=pt-BR" \
  -H "Authorization: Bearer talq_your_environment_token_here"
```

```javascript
// Requisição 2: Filtrar por idioma português
const response = await fetch('https://talkover.app/api/v1/voice-templates?language=pt-BR', {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer talq_your_environment_token_here'
  }
...
curl -X GET "https://talkover.app/api/v1/voice-templates?quality_tier=pro&gender=female" \
  -H "Authorization: Bearer talq_your_environment_token_here"
```

```javascript
// Requisição 3: Filtrar por qualidade profissional e gênero feminino
const response = await fetch('https://talkover.app/api/v1/voice-templates?quality_tier=pro&gender=female', {
  method: 'GET',
  headers: {
    'Authorization': 'Bearer talq_your_environment_token_here'
  }
