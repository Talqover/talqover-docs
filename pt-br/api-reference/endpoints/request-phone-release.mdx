...
```bash
curl -X POST "https://talkover.app/api/v1/phone-numbers/phone-uuid-1/request-release" \
...
```javascript
await fetch('https://talkover.app/api/v1/phone-numbers/phone-uuid-1/request-release', {
  method: 'POST',
  headers: {
