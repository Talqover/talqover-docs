...
Fluxos de chamada são projetos de conversa estruturados que:

- **Definem caminhos de conversa** - Mapeiam como as conversas devem progredir
- **Lidam com diferentes cenários** - Planejam respostas para várias entradas do interlocutor
- **Alcançam objetivos específicos** - Guiam conversas para resultados desejados
- **Mantêm contexto** - Acompanham o estado e progresso da conversa
- **Fornecem fallbacks** - Lidam com situações inesperadas graciosamente
